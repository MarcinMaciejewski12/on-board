  ...
  return (
    <LandingPageContainer>
      ...
      >
        ...
        <div>
          <LogoContainer>
            <h1 style={{color: 'white', fontSize: '50px'}}>KOŚCI ZOSTAŁY RZUCONE</h1>
          </LogoContainer>
          <DescriptionContainer>
          <MainDescription>
        ...
        <EncouragingLeaves>
          <LeavesContainer>
            <LeftLeaves>STATYSTYKI ROZGRYWEK</LeftLeaves>
          </LeavesContainer>
          <LeavesContainer style={{justifyContent: 'end'}}>
            <RightLeaves>LISTA ULUBIONYCH GIER</RightLeaves>
          </LeavesContainer>
          <LeavesContainer>
            <LeftLeaves>KALENDARIUM WYDARZEŃ</LeftLeaves>
          </LeavesContainer>
          <LeavesContainer style={{justifyContent: 'end'}}>
